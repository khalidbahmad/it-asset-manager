...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        ...
        'api' => [
            // Sanctum pour SPA ou API stateful
    ...
    /**
     * Route middleware - peuvent être appliqués individuellement aux routes.
     */
    protected $routeMiddleware = [
        ...
        'role' => \App\Http\Middleware\RoleMiddleware::class, // <- middleware pour rôle si utilisé
    ];
}